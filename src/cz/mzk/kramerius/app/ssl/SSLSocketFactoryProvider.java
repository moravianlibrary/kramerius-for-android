package cz.mzk.kramerius.app.ssl;
...
public class SSLSocketFactoryProvider {
	...
	private static final int[] CERT_RES_IDS = new int[] { R.raw.terena_ssl_ca_2_whole_chain };

	private static SSLSocketFactoryProvider instance;
	private final SSLContext sslContext;

	public static SSLSocketFactoryProvider instanceOf(Context context) throws KeyManagementException,
	...
	private SSLSocketFactoryProvider(Context context) throws KeyManagementException, CertificateException,
