...
public class DomainUtil {
	...
	private static List<Domain> DOMAINS = new ArrayList<Domain>() {
		...
		{
			add(new Domain(true, "Moravská zemská knihovna", "http", "kramerius.mzk.cz",
					R.drawable.logo_mzk));
			add(new Domain(true, "Národní digitální knihovna", "http", "krameriusndktest.mzk.cz",
					R.drawable.logo_ndk));
			...
			add(new Domain(false, "Krajská knihovna Karlovy Vary", "http", "k4.kr-karlovarsky.cz",
					R.drawable.logo_kkkv));							
			add(new Domain(false, "Knihovna Akademie věd ČR", "http", "kramerius.lib.cas.cz",
					R.drawable.logo_knav));
			add(new Domain(false, "Knihovna Západočeského muzea v Plzni", "http", "kramerius.zcm.cz",
					R.drawable.logo_zcm));														
			add(new Domain(false, "Univerzita Karlova v Praze - Fakulta sociálních věd", "http", "kramerius.fsv.cuni.cz",
					R.drawable.logo_cuni_fsv));													
			add(new Domain(false, "Městská knihovna v Praze", "http", "kramerius4.mlp.cz",
					R.drawable.logo_mlp));			
			...
			add(new Domain(false, "Národní knihovna", "http", "kramerius4.nkp.cz",
					R.drawable.logo_nkp));									
			add(new Domain(false, "Národní technická knihovna", "http", "kramerius.techlib.cz",
					R.drawable.logo_ntk));			
			...
			add(new Domain(false, "Krajská knihovna Františka Bartoše ve Zlíně", "http", "dlib.kfbz.cz", R.drawable.logo_kfbz));


								
			add(new Domain(false, "Česká digitální knihovna", "http", "cdk-test.lib.cas.cz",
					R.drawable.logo_cdk));			
